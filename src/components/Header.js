...
const Header = () => (
  <Container fluid>
    <Row className="align-items-center" style={{ height: '100%', backgroundColor: 'blue' }}>
      <Col className='logo-container' xs={8} md={3} lg={2}>
        <img className="companyLogo " src={Logo} alt="Company Logo" />
      </Col>
      <Col className="d-flex justify-content-center" xs={4} md={6} lg={8}>
        <Navigation />
      </Col>
      <Col className="d-flex justify-content-end align-items-center d-none d-md-block" xs={4} md={3} lg={2}>
